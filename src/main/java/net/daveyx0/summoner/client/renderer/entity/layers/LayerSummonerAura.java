...
public class LayerSummonerAura implements LayerRenderer {

	private RenderLivingBase renderer;
    private static final ResourceLocation LIGHTNING_TEXTURE = new ResourceLocation("thesummoner","textures/entity/summoner/invulnerable_effect.png");

	public LayerSummonerAura(RenderLivingBase renderer) {
	...
	{
		if (entitylivingbaseIn instanceof EntitySummoner) {
			
			EntitySummoner summoner = (EntitySummoner)entitylivingbaseIn;
			if(summoner.isInvinsible())
			{
